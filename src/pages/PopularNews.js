...
const PopularNews = () => {
  ...
  const onClickBtn = () => {
    // const url = pageName === "popular" ? "/posts/popular/" : "/posts/news/";
    // location(url);
    navitate("/posts/list/");
  };
    ...
    <div className={styles.page}>
      ...
      <Suspense fallback={<Loading />}>
        <Await resolve={postsList}>
          {postsList.length === 0 ? (
            <>
              <div className={classes.text_containder}>
                <span className={classes.text_main}>
                  아직 게시글이 없습니다.
                </span>
                <span className={classes.text_sub}>
                  {pageName === "popular"
                    ? "게시글을 작성해주세요!"
                    : "좋아요를 눌러주세요!"}
                </span>
              ...
              <div className={classes.btn_div}>
                <div className={classes.sp} onClick={onClickBtn}>
                  <button className={classes["sparkle-button"]}>
                  ...
                  <div className={classes.bodydrop}></div>
                  <span aria-hidden="true" className={classes["particle-pen"]}>
                    <svg
